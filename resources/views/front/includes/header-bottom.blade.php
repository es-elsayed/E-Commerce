                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                                            ...
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="item "><a href="#"
                                                                            ...
                                                                            LoudSpeaker</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="Tangent Audio">Tangent Audio</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="col-lg-3 col-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="item  parent"><a href="#"
                                                                            title="Samsung ">Samsung </a></li>
                                                                    <li class="item "><a href="#" title="OPPO ">OPPO
                                                                        </a></li>
                                                                    <li class="item "><a href="#" title="Sony">Sony</a>
                                                                    </li>
                                                                    <li class="item "><a href="#" title="Xiaomi ">Xiaomi
                                                                        </a></li>
                                                                    <li class="item "><a href="#" title="Huawei ">Huawei
                                                                        </a></li>
                                                                    <li class="item "><a href="#" title="Nokia ">Nokia
                                                                        </a></li>
                                                                    <li class="item "><a href="#"
                                    ...
                                    <li class="item "><a href="#" title="Monitor &amp; Television"><i
                                            ...
                                            &amp; Television</a><span class="menu-sub-title">Sony BRAVIA, SamSung, TV 4K
                                            ...</span></li>
                                </ul>
                            </div>
                        </div>
